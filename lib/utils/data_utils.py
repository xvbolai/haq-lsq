...
def get_dataset(dataset_name, batch_size, n_worker, data_root='data/imagenet', for_inception=False):
    ...
    if dataset_name == 'imagenet':
        ...
        trainset = datasets.CIFAR100(root=traindir, train=True, transform=train_transform, download=True)
        valset = datasets.CIFAR100(root=valdir, train=False, transform=test_transform, download=True)
...
def get_split_train_dataset(dataset_name, batch_size, n_worker, val_size, train_size=None, random_seed=1,
    ...
    if dataset_name == 'imagenet':
        ...
        trainset = datasets.CIFAR100(root=traindir, train=True, transform=train_transform, download=True)
        valset = datasets.CIFAR100(root=traindir, train=False, transform=test_transform, download=True)
